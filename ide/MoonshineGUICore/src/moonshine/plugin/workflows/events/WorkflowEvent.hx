...
package moonshine.plugin.workflows.events;
...
{
	public static final LOAD_WORKFLOW:String = "loadNewWorkflow";
	...
	{
		return new WorkflowEvent(this.type, this.project, this.workflows);
	}
}