...
class DebugAdapterViewStackFrameEvent extends Event {
	public static final GOTO_STACK_FRAME = "gotoStackFrame";
	...
	override public function clone():Event {
		return new DebugAdapterViewStackFrameEvent(this.type, this.stackFrame);
	}
}
