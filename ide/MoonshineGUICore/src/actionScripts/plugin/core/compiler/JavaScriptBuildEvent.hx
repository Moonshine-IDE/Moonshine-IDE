...
class JavaScriptBuildEvent extends Event {
	public static final BUILD_AND_RUN:String = "compilerRoyaleBuildAndRun";
	public static final BUILD_AND_DEBUG:String = "compilerRoyaleBuildAndDebug";
