...
// 
////////////////////////////////////////////////////////////////////////////////
package actionScripts.plugin.moduleproj
{
	...
	import actionScripts.plugin.ondiskproj.vo.ModuleProjectVO;
	...
	public class CreateModuleProject extends ConsoleOutputter
	{
		public function CreateModuleProject(event:NewProjectEvent)
		{
			createModule(event);
		}
		
		private var project:ModuleProjectVO;
		...
		private function createModule(event:NewProjectEvent):void
		{
			...
			project = new ModuleProjectVO(event.templateDir, projectName);
		...
		private function getProjectSettings(project:ModuleProjectVO, eventObject:NewProjectEvent):SettingsWrapper
		{
		...
		private function createSave(event:Event):void
		{
			...
			var view:SettingsView = event.target as SettingsView;
			var project:ModuleProjectVO = view.associatedData as ModuleProjectVO;
			...
			project = createFileSystemBeforeSave(project, view.exportProject as ModuleProjectVO);
			if (!project)
			{
				return;
			}
		...
		private function createFileSystemBeforeSave(pvo:ModuleProjectVO, exportProject:ModuleProjectVO = null):ModuleProjectVO
		{	
