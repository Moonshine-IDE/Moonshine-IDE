...
package actionScripts.plugin.ondiskproj.vo
{
	...
	public class ModuleProjectVO extends ProjectVO implements IVisualEditorProjectVO
	{
		...
		public function ModuleProjectVO(folder:FileLocation, projectName:String = null, updateToTreeView:Boolean = true)
		{
