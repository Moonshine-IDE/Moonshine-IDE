...
package actionScripts.plugin.syntax
{
	...
	public class HTMLSyntaxPlugin extends PluginBase implements  ISettingsProvider
	{
		private static const FILE_EXTENSION_HTML:String = "html";
		private static const FILE_EXTENSION_HTM:String = "htm";
		private static const FILE_EXTENSION_XHTML:String = "xhtml";
		private static const FILE_EXTENSION_GSP:String = "gsp";
		...
		{
			return type == FILE_EXTENSION_HTML
				|| type == FILE_EXTENSION_HTM
				|| type == FILE_EXTENSION_XHTML
				|| type == FILE_EXTENSION_GSP;
		}
		...
		{
			var formatBuilder:HTMLSyntaxFormatBuilder = new HTMLSyntaxFormatBuilder();
