...
package actionScripts.plugin.syntax
{
	...
	public class CSSSyntaxPlugin extends PluginBase implements  ISettingsProvider
	{
		private static const FILE_EXTENSION_CSS:String = "css";
		...
		{
			return type == FILE_EXTENSION_CSS;
		}
		...
		{
			var formatBuilder:CSSSyntaxFormatBuilder = new CSSSyntaxFormatBuilder();
			...
			textEditor.setParserAndTextStyles(new CSSLineParser(), formats);
