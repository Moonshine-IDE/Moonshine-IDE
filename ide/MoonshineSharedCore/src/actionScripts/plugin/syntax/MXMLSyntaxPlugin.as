...
package actionScripts.plugin.syntax
{
	...
	public class MXMLSyntaxPlugin extends PluginBase implements  ISettingsProvider
	{
		...
		{
			return type == FILE_EXTENSION_MXML;
		}
		...
		{
			var formatBuilder:MXMLSyntaxFormatBuilder = new MXMLSyntaxFormatBuilder();
