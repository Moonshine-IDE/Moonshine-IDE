...
package actionScripts.plugin.syntax
{
	...
	public class JavaSyntaxPlugin extends PluginBase implements  ISettingsProvider
	{
		private static const FILE_EXTENSION_JAVA:String = "java";
		...
		{
			return type == FILE_EXTENSION_JAVA;
		}
		...
		{
			var formatBuilder:JavaSyntaxFormatBuilder = new JavaSyntaxFormatBuilder();
