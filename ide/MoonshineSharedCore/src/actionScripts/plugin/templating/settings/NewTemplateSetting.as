...
package actionScripts.plugin.templating.settings
{
	...
	public class NewTemplateSetting extends AbstractSetting
	{
		protected var rdr:NewTemplateRenderer = new NewTemplateRenderer();
		
		public var fakeSetting:String = "";
		
		public function NewTemplateSetting(label:String)
		{
			super();
			this.provider = this;
