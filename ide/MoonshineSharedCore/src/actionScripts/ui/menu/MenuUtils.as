...
package actionScripts.ui.menu
{
    ...
    public class MenuUtils
    {
        ...
        public static var menuItemsEnabledInVEProject:Array = [
			...
			resourceManager.getString('resources', 'ACCESS_MANAGER'),
			...
			resourceManager.getString('resources', 'FIND_RESOURCES'),
            resourceManager.getString('resources', 'FINDE_PREV'),
			resourceManager.getString('resources', 'BUILD_APACHE_ANT'),
			...
			resourceManager.getString('resources', 'BUILD_AWAY3D_MODEL'),
