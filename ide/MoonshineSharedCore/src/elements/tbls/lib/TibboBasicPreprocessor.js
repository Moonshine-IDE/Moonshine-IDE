...
exports.PreprocessorListener = exports.TibboBasicPreprocessor = void 0;
...
class TibboBasicPreprocessor {
    ...
    getFilePath(currentDirectory, filePath) {
        let platformLibs = path.join(this.platformsPath, 'src', this.platformVersion);
...
exports.TibboBasicPreprocessor = TibboBasicPreprocessor;
