 ...
 * @productversion 1.0
 */
public class ScriptTagNode extends ScriptNode implements IScriptTag
{
	//--------------------------------------------------------------------------
	//
	 ...
	 * doc
	 */
	public function get block():IScriptBlock
	{
	 ...
	 * Constructor.
	 */
	public function ScriptTagNode(node:IParserNode)
	{
		super(node);
	}
