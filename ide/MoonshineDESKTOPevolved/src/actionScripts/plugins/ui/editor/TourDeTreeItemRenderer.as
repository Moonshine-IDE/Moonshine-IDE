...
package actionScripts.plugins.ui.editor
{
	...
	public class TourDeTreeItemRenderer extends TreeItemRenderer
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
    	{
			...
			if (model.activeEditor is TourDeTextEditor && TourDeTextEditor(model.activeEditor).currentFile)
			{
				var pattern:RegExp = new RegExp(/(\\)/g);
				var nodeApp:String = data.@app;
				var pathNode: String = TourDeTextEditor(model.activeEditor).currentFile.fileBridge.nativePath.replace(pattern, "/");
