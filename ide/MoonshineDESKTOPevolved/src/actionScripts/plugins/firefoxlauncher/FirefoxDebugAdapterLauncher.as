...
// 
////////////////////////////////////////////////////////////////////////////////
package actionScripts.plugins.firefoxlauncher
{
	...
	public class FirefoxDebugAdapterLauncher extends ConsoleOutputter implements IDebugAdapterLauncher
	{
		private static const DEBUG_ADAPTER_PATH:String = "elements/firefox-debug-adapter/dist/adapter.bundle.js";
		...
		public function getStartupInfo(project:ProjectVO):NativeProcessStartupInfo
		{
			...
			{
				error("Debug session cancelled. A valid Node.js path must be defined to debug with Mozilla Firefox.");
